  ...
  const stats = [
    {
      ...
      value:
        analyticsData?.reduce(
          (sum: number, day: any) => sum + day.total_conversations,
          0
        ) || 0,
      change: "+12%",
      trend: "up",
    ...
    },
    {
      ...
      value:
        analyticsData?.reduce(
          (sum: number, day: any) => sum + day.active_users,
          0
        ) || 0,
      change: "+8%",
      trend: "up",
    ...
    },
    {
      ...
      value:
        analyticsData?.length > 0
          ? `${(
              (analyticsData.reduce(
                (sum: number, day: any) => sum + day.goal_completions,
                0
              ) /
                analyticsData.reduce(
                  (sum: number, day: any) => sum + day.total_conversations,
                  ...
                  <div className="w-24 bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${Math.min(
                          (node.visits /
                            Math.max(...heatmapData.map((n) => n.visits))) *
                            100,
                          100
                        )}%`,
                      }}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
            ...
            <p className="text-sm text-blue-700">
              Your chatbot performs best between 2-4 PM with 89% user
              satisfaction
            </p>
          </div>
          ...
          <div className="p-4 bg-orange-50 rounded-lg border-l-4 border-orange-500">
            ...
            <p className="text-sm text-orange-700">
              Consider adding more quick reply options to reduce fallback rate
              by 15%
            </p>
          </div>
        </div>
