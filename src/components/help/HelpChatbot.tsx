...
export function HelpChatbot({ isOpen, onClose }: HelpChatbotProps) {
  ...
  useEffect(() => {
    ...
    openAIService.setChatbotContext(
      'BotBuilder Pro Help Assistant - A no-code chatbot building platform. Help users with questions about creating, deploying, and managing chatbots.'
    );
  }, []);
  ...
  const initializeChat = () => {
    const welcomeMessage: Message = {
      ...
      sender: 'bot',
      content: 'Hi! 👋 I\'m your BotBuilder Pro assistant. I can help you with questions about creating chatbots, using features, deployment, pricing, and more.\n\nWhat would you like to know?',
      timestamp: new Date(),
      type: 'quick_replies',
      options: [
        '🚀 Getting Started',
  ...
  const processUserMessage = async (userInput: string) => {
    ...
    if (userInput.includes('Getting Started')) {
      botResponse = '🚀 **Getting Started Help**\n\nI can help you with:\n• Creating your first chatbot\n• Understanding templates\n• Basic setup and configuration\n• Publishing your bot\n\nWhat specific topic would you like help with?';
      ...
      if (searchResults.length > 0) {
        ...
        try {
          const aiResponse = await openAIService.generateResponse(
            userInput,
            `You are a helpful assistant for BotBuilder Pro, a no-code chatbot building platform. 
          ...
          botResponse = 'I\'m having trouble processing that question right now. Let me suggest some common topics that might help, or you can contact our support team for personalized assistance.';
          messageType = 'quick_replies';
          options = [
            '🚀 Getting Started',
            '🤖 AI Features', 
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-100">Ask me anything about BotBuilder Pro</p>
            </div>
          </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {/* FAQ Results */}
                        {message.type === 'faq_results' && message.faqResults && (
