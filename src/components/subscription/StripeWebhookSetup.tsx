...
export function StripeWebhookSetup({
  ...
  const testWebhook = async () => {
    ...
    try {
      ...
      setWebhookStatus("error");
      toast.error(`Failed to test webhook endpoint: ${error}`);
    } finally {
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-yellow-800 text-sm">
                  Make sure your Stripe webhook function is deployed in Supabase
                  before proceeding. You can check this in your Supabase
                  Dashboard under Edge Functions.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
            ...
            <p className="text-orange-800 text-sm mb-3">
              After creating the webhook, you'll need to get the signing secret
              to verify webhook authenticity.
            </p>
            <ol className="space-y-1 text-sm text-orange-800">
              <li>
                1. Click on your newly created webhook in the Stripe Dashboard
              </li>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button
                ...
                variant="outline"
                onClick={() =>
                  copyToClipboard(`STRIPE_WEBHOOK_SECRET=${webhookSecret}`)
                }
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-blue-800 text-sm mb-3">
              You need to update the price IDs in your Stripe configuration with
              your actual Stripe product price IDs.
            </p>
          </div>
  ...
  // ... other config
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <ol className="space-y-1 text-sm text-yellow-800">
              ...
              <li>
                2. Create products for Pro ($29/month) and Enterprise
                ($99/month) if not already created
              </li>
