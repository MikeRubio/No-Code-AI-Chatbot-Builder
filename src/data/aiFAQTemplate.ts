export const aiFAQTemplate = {
  ...
  description:
    "An intelligent FAQ bot that uses AI to understand questions and provide accurate answers from your knowledge base. Includes smart fallback to human agents.",
  ...
  settings: {
    welcomeMessage:
      "Hi! I'm your AI-powered assistant. I can help answer your questions using our knowledge base.",
    fallbackMessage:
      "Let me connect you with a human expert who can provide more detailed assistance.",
  },
  flow: {
    nodes: [
      {
        ...
        data: {
          ...
          label: "AI Welcome",
          content:
            "Hello! 🤖 I'm your AI-powered FAQ assistant. I have access to our complete knowledge base and can help answer questions about our products, services, policies, and more.\n\nWhat would you like to know?",
        },
      },
      {
        id: "ai-response-main",
...
Make this response significantly more detailed than the previous one while staying focused on their original question.`,
      ...
      // New question path - loops back to AI
      {
        ...
        data: {
          ...
          content:
            "Perfect! I'm ready to help with your new question. 🤔\n\nI have access to information about:\n• Products and services\n• Pricing and billing\n• Technical support\n• Account management\n• Policies and procedures\n• Getting started guides\n\nWhat would you like to know?",
        },
      },
...
- If no results found, explain what you searched and suggest alternatives`,
        ...
        data: {
          ...
          fields: [
            ...
            },
            {
              ...
              type: "text",
              required: false,
              label: "What specific information interests you most?",
            },
          ],
        },
      },
            ...
            questions: [
              {
                type: "rating",
                question:
                  "How helpful was the AI assistant in answering your questions?",
                required: true,
              },
              {
                type: "rating",
              ...
              },
              {
                type: "text",
                question:
                  "What topics would you like to see added to the knowledge base?",
                required: false,
              },
            ],
            collectNPS: true,
    ...
    edges: [
      ...
      },
      {
        id: "e5",
        source: "conditional-followup",
        target: "ai-response-details",
        condition: "more_info",
      },
      {
        id: "e6",
        source: "conditional-followup",
        target: "message-new-question",
        condition: "new_question",
      },
      {
        id: "e7",
        source: "conditional-followup",
      ...
      },
      {
        id: "e8",
        source: "conditional-followup",
        target: "ai-response-search",
        condition: "new_search",
      },
      ...
      {
        id: "e14",
        source: "conditional-final",
        target: "message-complete",
        condition: "complete",
      },
      {
        id: "e15",
        source: "conditional-final",
        target: "ai-response-main",
        condition: "loop_back",
      },
      {
        id: "e16",
      ...
      },
      {
        id: "e17",
        source: "conditional-final",
        target: "lead-capture-info",
        condition: "lead_capture",
      },
      {
        id: "e18",
        source: "conditional-final",
